                ...
                <div class="contact-info">
                    ...
                    <div class="media">
                        <div class="media-body">
                            ...
                            <p>Ngongo Road / Adams </p>
                        </div>
                    </div>
                    <div class="media">
                        <div class="media-body">
                            <h5 class="title">Phone Number</h5>
                            <p>Office<a href="tel:0477-0477-8556-552">: 07000000000</a> </p>
                            <p>Mobile<a href="tel:+0477-85x6-552">: +254 7003338888</a> </p>
                        </div>
                    </div>
                    <div class="media mrg-btn-0">
                        <div class="media-body">
                            <h5 class="title">Email Address</h5>
                            <p><a href="#">estate@estate.com</a></p>
                            <p><a href="#">http://estate.com</a></p>
                        </div>
                    </div>
                </div>
            </div>
